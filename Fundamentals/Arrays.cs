...
namespace Arrays
{
    class Program
    {
        ...
        private static void ZigZagArrays()
        {
            int n = int.TryParse(Console.ReadLine(), out n) ? n : 1;
        ...
        private static void ArrayRoatation()
        {
        ...
        private static void MaxSequenceOfEqualElements()
        {
        ...
        private static void KaminoFactory()
        {
